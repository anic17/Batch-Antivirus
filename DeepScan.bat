...
if "%head:~0,4%"=="��  " set "obfuscated=1"&set "ofc=FF FE 00 00"&set "extra_info=FF FE 00 00"
if "%head:~0,2%"=="��" set "obfuscated=1"&set "obfc=FE FF"&set "extra_info=FE FF"
if "%head:~0,2%"=="��" set "obfuscated=1"&set "obfc=FF FE"&set "extra_info=FF FE"
